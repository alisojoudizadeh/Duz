#read//me//
#Coded By Ali sojoudizadeh
#before run please install tkinter modules from pip
from tkinter import *

import tkinter.messagebox
tk = Tk()
tk.title("Duz Project <Amir Aryanmehr>")
    ...
    if buttons["text"] == " " and click == True:
        ...
        click = True
          ...
          tkinter.messagebox.showinfo("Winner X", "You Won the game")
            ...
            tkinter.messagebox.showinfo("Winner P", "You Won the game")
